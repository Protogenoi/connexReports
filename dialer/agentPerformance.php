...
<!DOCTYPE html>
<html lang="en">
<title>ADL | Agent Performance</title>
<meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="card">
        <h3 class="card-header">
            <i class="fa fa-line-chart"></i> Agent Performance
        </h3>
        ...
        <div class="card-block">
            ...
            <div class="col-12">
                ...
                if(isset($dateFrom)) {
                    require_once ('../php/agentPerformanceTimed.php');
    ...
    <div class="col-md-12">
        <div class="btn-group"></div>
            <button onclick="exportTableToCSV('agentPerformance.csv')" class="btn btn-success"><i class="fa fa-download"></i> Download</button>
